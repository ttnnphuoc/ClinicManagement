...
namespace ClinicManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250925073633_AddSubscriptionManagementWithNullableOwner")]
    partial class AddSubscriptionManagementWithNullableOwner
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicManagement.Core.Entities.PackageLimit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ClinicManagement.Core.Entities.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ClinicManagement.Core.Entities.SubscriptionPackage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsTrialPackage")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ClinicManagement.Core.Entities.UsageTracking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ClinicManagement.Core.Entities.Clinic", b =>
                {
                    b.HasOne("ClinicManagement.Core.Entities.Staff", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("ClinicManagement.Core.Entities.PackageLimit", b =>
                {
                    b.HasOne("ClinicManagement.Core.Entities.SubscriptionPackage", "SubscriptionPackage")
                        .WithMany("PackageLimits")
            ...
            modelBuilder.Entity("ClinicManagement.Core.Entities.Subscription", b =>
                {
                    ...
                    b.HasOne("ClinicManagement.Core.Entities.Staff", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ClinicManagement.Core.Entities.UsageTracking", b =>
                {
                    b.HasOne("ClinicManagement.Core.Entities.Subscription", "Subscription")

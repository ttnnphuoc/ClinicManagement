        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstVisitDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffClinics", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StaffClinics_Staff_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffClinics_StaffId_ClinicId",
                table: "StaffClinics",
                columns: new[] { "StaffId", "ClinicId" },
                unique: true);

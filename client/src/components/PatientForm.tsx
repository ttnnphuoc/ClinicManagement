import { Form, Input, Button, DatePicker, Select, Collapse, Checkbox, Row, Col, App } from 'antd';
import { useTranslation } from 'react-i18next';
import { useEffect } from 'react';
import dayjs from 'dayjs';
import { patientService } from '../services/patientService';
import type { Patient, CreatePatientRequest } from '../services/patientService';
    ...
    >
      ...
      <Form.Item>
        ...
        <Col span={8}>
          <Collapse defaultActiveKey={['1']} items={[
            {
              key: '1',
              label: t('patients.insuranceInfo'),
              children: (
                <>
      ...
      <Form.Item>
        <Collapse defaultActiveKey={['1']} items={[
          {
            key: '1',
            label: t('patients.emergencyContact'),
            children: (
              <>
                <Row gutter={16}>
                  <Col span={12}>
